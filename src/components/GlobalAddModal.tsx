    ...
    const renderChoice = () => (
        <div className="grid grid-cols-1 gap-4">
            <button
                ...
                className="group p-6 bg-zinc-50 border border-zinc-100 rounded-[2rem] flex items-center gap-6 hover:bg-zinc-200 transition-all duration-300"
            >
                ...
                <div className="text-left">
                    <h3 className="text-lg font-bold text-zinc-950 group-hover:text-zinc-950 transition-colors">Lançamento</h3>
            ...
            >
                ...
                <div className="text-left">
                    <h3 className="text-lg font-bold text-zinc-950 group-hover:text-zinc-950 transition-colors">Plantão</h3>
            ...
            >
                ...
                <div className="text-left">
                    <h3 className="text-lg font-bold text-zinc-950 group-hover:text-zinc-950 transition-colors">Ativo ou Passivo</h3>
